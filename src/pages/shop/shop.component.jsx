...
import ItemProfile from "../item-profile/item-profile.component";
...
const ItemProfileWithSpinner = WithSpinner(ItemProfile);
    ...
    return (
      <div className='shop-page'>
        ...
        <Route
          ...
          render={(props) => (
            <ItemProfileWithSpinner isLoading={loading} {...props} />
          )}
        />
      </div>
    );
